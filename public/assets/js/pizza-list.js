...
// getPizzaList gets all pizza data, transforms it into JSON data that we can use, and runs each one through the printPizza function using the .forEach() method
const getPizzaList = () => {
  fetch("/api/pizzas")
